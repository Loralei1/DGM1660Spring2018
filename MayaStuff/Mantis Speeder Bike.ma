...
//Last modified: Wed, Jan 24, 2018 07:39:57 PM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 14.538754487402738 7.8117895635169363 11.718032259395109 ;
	setAttr ".r" -type "double3" 341.06164727037242 1859.7999999945657 3.1614598011986989e-015 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "24DE203A-47FE-1B8B-F979-C29459D1912C";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 17.543384411774042;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr -s 14 ".pt";
	setAttr ".pt[32]" -type "float3" -0.026232544 0 0 ;
	setAttr ".pt[33]" -type "float3" 0.026232544 0 0 ;
	setAttr ".pt[52]" -type "float3" 0.011576787 0 0 ;
	setAttr ".pt[55]" -type "float3" -0.011576787 0 0 ;
	setAttr ".pt[56]" -type "float3" 0.013126211 0 0 ;
	setAttr ".pt[59]" -type "float3" -0.013126211 0 0 ;
	setAttr ".pt[218]" -type "float3" 0.021813065 0 0 ;
	setAttr ".pt[219]" -type "float3" 0.033389851 0 0 ;
	setAttr ".pt[227]" -type "float3" -0.021813065 0 0 ;
	setAttr ".pt[228]" -type "float3" -0.033389851 0 0 ;
	setAttr ".pt[270]" -type "float3" 0.026232544 0 0 ;
	setAttr ".pt[271]" -type "float3" 0.013126211 0 0 ;
	setAttr ".pt[277]" -type "float3" -0.026232544 0 0 ;
	setAttr ".pt[278]" -type "float3" -0.013126211 0 0 ;
...
createNode transform -n "pasted__pCube3" -p "group1";
	...
	setAttr ".t" -type "double3" 0 0.50980789671310633 -0.047013864131607797 ;
...
createNode mesh -n "pasted__pCubeShape3" -p "|group1|pasted__pCube3";
	...
	setAttr ".vir" yes;
	setAttr ".vif" yes;
	setAttr ".pv" -type "double2" 0.38818736374378204 0.1019868478178978 ;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 12 ".pt";
	setAttr ".pt[12]" -type "float3" 0 -2.8312206e-007 -1.1920929e-007 ;
	setAttr ".pt[13]" -type "float3" 0 -2.8312206e-007 -1.1920929e-007 ;
	setAttr ".pt[20]" -type "float3" -2.8871e-008 -3.7252903e-009 -2.2351742e-008 ;
	setAttr ".pt[26]" -type "float3" 2.8871e-008 -3.7252903e-009 -2.2351742e-008 ;
	setAttr ".pt[30]" -type "float3" -1.5300639 3.6363561 -0.074200697 ;
	setAttr ".pt[31]" -type "float3" -1.5300639 3.6363561 -0.074200697 ;
	setAttr ".pt[32]" -type "float3" -1.5300639 3.6363561 -0.074200697 ;
	setAttr ".pt[33]" -type "float3" 2.4314873 0 0 ;
	setAttr ".pt[34]" -type "float3" 2.4314873 0 0 ;
	setAttr ".pt[35]" -type "float3" 2.4314873 0 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
...
createNode polyTweak -n "polyTweak37";
	...
	setAttr ".uopa" yes;
	setAttr -s 7 ".tk";
	setAttr ".tk[56]" -type "float3" -0.0007296562 0 0 ;
	setAttr ".tk[57]" -type "float3" -0.0007296562 0 0 ;
	setAttr ".tk[58]" -type "float3" -0.0007296562 0 0 ;
	setAttr ".tk[59]" -type "float3" -0.0007296562 0 0 ;
...
createNode polyTweak -n "polyTweak38";
	...
	setAttr ".uopa" yes;
	setAttr -s 24 ".tk";
	setAttr ".tk[42]" -type "float3" -0.15566944 -1.1449175e-016 -0.10664842 ;
	setAttr ".tk[43]" -type "float3" -0.10664858 -1.1449175e-016 -0.20285755 ;
	setAttr ".tk[44]" -type "float3" -0.030296637 -1.1449175e-016 -0.27920946 ;
	setAttr ".tk[45]" -type "float3" 0.065912358 -1.1449175e-016 -0.3282305 ;
	setAttr ".tk[46]" -type "float3" 0 -1.1449175e-016 -0.34512177 ;
	setAttr ".tk[47]" -type "float3" -0.065912358 -2.289835e-016 -0.32823059 ;
	setAttr ".tk[48]" -type "float3" 0.030296687 -2.289835e-016 -0.27920949 ;
	setAttr ".tk[49]" -type "float3" 0.10664865 -2.289835e-016 -0.20285757 ;
	setAttr ".tk[50]" -type "float3" 0.15566957 -2.289835e-016 -0.10664854 ;
	setAttr ".tk[51]" -type "float3" 0.17256086 -2.289835e-016 6.1712591e-008 ;
	setAttr ".tk[52]" -type "float3" 0.15566942 -2.289835e-016 0.10664856 ;
	setAttr ".tk[53]" -type "float3" 0.10664846 -2.289835e-016 0.20285755 ;
	setAttr ".tk[54]" -type "float3" 0.030296562 -2.289835e-016 0.27920946 ;
	setAttr ".tk[55]" -type "float3" -0.065912433 -2.289835e-016 0.3282305 ;
	setAttr ".tk[56]" -type "float3" 0 -1.1449175e-016 0.34512177 ;
	setAttr ".tk[57]" -type "float3" 0.065912396 -1.1449175e-016 0.32823056 ;
	setAttr ".tk[58]" -type "float3" -0.03029659 -1.1449175e-016 0.27920949 ;
	setAttr ".tk[59]" -type "float3" -0.1066485 -1.1449175e-016 0.20285761 ;
	setAttr ".tk[60]" -type "float3" -0.15566944 -1.1449175e-016 0.10664861 ;
	setAttr ".tk[61]" -type "float3" -0.17256099 -1.1449175e-016 6.1712591e-008 ;
...
connectAttr "polyExtrudeFace25.out" "|group|pasted__pCube3|pasted__pCubeShape3.i"
		;
connectAttr "deleteComponent7.og" "|group1|pasted__pCube3|pasted__pCubeShape3.i"
		;
