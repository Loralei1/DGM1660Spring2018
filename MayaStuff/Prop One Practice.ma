...
//Last modified: Tue, Jan 23, 2018 02:30:37 PM
//Codeset: 1252
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 2.1590180280104976 -0.68388213129904207 -5.7872179924420131 ;
	setAttr ".r" -type "double3" 5.6616472553740911 3743.7999999862673 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "0886BC83-4B26-DFB4-541E-37BA4317EC7D";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 6.6342851434078778;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "BDABC14D-4BDB-C24D-8EF8-89A0AB54E373";
	setAttr -s 3 ".lnk";
	setAttr -s 3 ".slnk";
createNode shapeEditorManager -n "shapeEditorManager";
	rename -uid "CA9D15A2-4CE1-F1B8-A973-6A971616D555";
createNode poseInterpolatorManager -n "poseInterpolatorManager";
	rename -uid "1782343D-47C4-FF4E-FBED-B09512BD56AB";
createNode displayLayerManager -n "layerManager";
	rename -uid "9F25AD15-4621-57E4-2245-658AFF7F178A";
createNode displayLayer -n "defaultLayer";
	rename -uid "6C3D6CA1-4749-04DF-DDD9-CFB4A06F858B";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "3F1AA65E-4F8C-92E3-703A-1CAC7F30C7B3";
