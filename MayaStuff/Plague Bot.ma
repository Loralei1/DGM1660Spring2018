...
//Name: Plague Bot.ma
//Last modified: Mon, Feb 12, 2018 11:26:16 AM
//Codeset: 1252
requires maya "2017";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.060691940336474293 0.79027337122129282 3.8324358628929236 ;
	setAttr ".r" -type "double3" 0.86164726812571546 1084.1999999974155 -4.9829986461249453e-017 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "7A78F85D-4E8B-2BF0-9638-C39E48EF1E76";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999993;
	setAttr ".coi" 4.0315412323166377;
...
createNode transform -n "pCube3";
	...
	setAttr ".t" -type "double3" 0 2.7971732146057899 -0.18242525325333653 ;
...
createNode transform -n "pCube4";
	...
	setAttr ".t" -type "double3" 0 2.6456270159584605 -0.15769347859139229 ;
...
createNode transform -n "pCube10";
	...
	setAttr ".t" -type "double3" 0 2.5373028136472771 -0.45244891744351201 ;
...
createNode transform -n "pCube11";
	...
	setAttr ".t" -type "double3" 0 1.6788404135378254 -0.1504409126261112 ;
...
createNode transform -n "pCylinder2";
	...
	setAttr ".t" -type "double3" -0.10082499429269481 2.7256068365342583 0.21800068021846286 ;
...
createNode transform -n "pCube12";
	...
	setAttr ".t" -type "double3" 0 1.1362546716596231 -0.2419663398525122 ;
...
createNode transform -n "pCube14";
	...
	setAttr ".t" -type "double3" 1.1477592611523337 1.8312206608671446 0 ;
...
createNode mesh -n "pCubeShape15" -p "pCube15";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 32 ".pt";
	setAttr ".pt[27]" -type "float3" -7.7975972e-009 0 0 ;
	setAttr ".pt[28]" -type "float3" 7.7975972e-009 0 0 ;
	setAttr ".pt[29]" -type "float3" 7.6611206e-009 0 0 ;
	setAttr ".pt[30]" -type "float3" 7.6611206e-009 0 0 ;
	setAttr ".pt[32]" -type "float3" 7.7975972e-009 0 0 ;
	setAttr ".pt[33]" -type "float3" 2.3858515e-008 0 0 ;
	setAttr ".pt[34]" -type "float3" 7.6611206e-009 0 0 ;
	setAttr ".pt[37]" -type "float3" 2.3858515e-008 0 0 ;
	setAttr ".pt[38]" -type "float3" 7.6611206e-009 0 0 ;
	setAttr ".pt[40]" -type "float3" 7.7975972e-009 0 0 ;
	setAttr ".pt[41]" -type "float3" 2.3858515e-008 0 0 ;
	setAttr ".pt[51]" -type "float3" -0.012152784 0 0 ;
	setAttr ".pt[53]" -type "float3" 0.012152786 0 0 ;
	setAttr ".pt[55]" -type "float3" -0.012152784 0 0 ;
	setAttr ".pt[57]" -type "float3" 0.012152786 0 0 ;
	setAttr ".pt[59]" -type "float3" -0.012152784 0 0 ;
	setAttr ".pt[61]" -type "float3" 0.012152786 0 0 ;
	setAttr ".pt[63]" -type "float3" -0.012152784 0 0 ;
	setAttr ".pt[65]" -type "float3" 0.012152786 0 0 ;
	setAttr ".pt[74]" -type "float3" -0.012152786 0 0 ;
	setAttr ".pt[75]" -type "float3" 0.012152784 0 0 ;
	setAttr ".pt[78]" -type "float3" 0.012152784 0 0 ;
	setAttr ".pt[79]" -type "float3" -0.012152786 0 0 ;
	setAttr ".pt[84]" -type "float3" 0.012152784 0 0 ;
	setAttr ".pt[85]" -type "float3" -0.012152786 0 0 ;
	setAttr ".pt[90]" -type "float3" 0.012152784 0 0 ;
	setAttr ".pt[91]" -type "float3" -0.012152786 0 0 ;
	setAttr ".ai_translator" -type "string" "polymesh";
...
connectAttr "polySmoothFace2.out" "pCubeShape15.i";
